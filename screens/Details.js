...
export default class DetailsScreen extends Component {
  constructor(props) {
    ...
    this.state = {
      details: {},
      imagePath: "",
       url: "http://localhost:5000/"  //running on local server - to check on web
       //if hosting on ngrok - to check on phone
     // url: `https://daca-92-97-110-2.in.ngrok.io/planet?name=${this.props.navigation.getParam(
     //   "planet_name"
      //)}`
    };
  }
